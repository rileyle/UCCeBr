...
CeBr3_3x6_Detector::CeBr3_3x6_Detector(G4LogicalVolume* experimentalHall_log,
				       Materials* mat)
{
  materials=mat;
  ...
  canLength    = 154*mm; // 104 mm for 3"x4" 154 mm for 3"x6"
  canThickness = 1.0*mm;
  canRadius    = 82.8/2*mm;
...
CeBr3_3x6_Detector::~CeBr3_3x6_Detector()
{
}

void CeBr3_3x6_Detector::Construct()
{
...
//---------------------------------------------------------------------
void CeBr3_3x6_Detector::MakeSensitive(TrackerGammaSD* TrackerGamma)
{
